...
.parking-id, .parking-cost{
   ...
   <body>
      ...
      <form action="/book-parking-slot" method="post">
		...
		<div class="parking-cost"><label for="park_cost">Parking Cost Per Hours</label>
		 	    &ensp; 
 	    ...
 	    &ensp; &emsp; &emsp; &ensp; 
 	    <input type="text" id="vehicle_number"name="vehicle_number" placeholder="GJ-01-XY-1234"><br></br>
